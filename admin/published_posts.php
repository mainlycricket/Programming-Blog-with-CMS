...
<html lang="en">
  <head>
    ...
    <title>Published Posts | Admin Panel</title>
  </head>
  <body>
  ...
  <div id = "outer">
      ...
      <div id = "header">
        ...
        <h1>Published Posts: Ace Dev Blog</h1>
...
$sql = "SELECT * from tbl_posts where status = 'published'";
...
if($post = mysqli_query($conn, $sql)) {
    ...
    if(mysqli_num_rows($post) > 0) {
        ...
        while($row = mysqli_fetch_array($post)) {
            ...
            if($_SESSION['author_role'] == 'admin' || $_SESSION['author_email'] == $row['published_by']):
              echo "<a href = 'edit_post.php?id={$row['id']}'>Edit Post</a>&emsp;".
